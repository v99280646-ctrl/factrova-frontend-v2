                ...
                <div className="space-y-3 p-4">
                  {(project.materials ?? []).map((material, index) => (
                    <div
                      ...
                      className="grid gap-3 rounded-md border border-border/70 bg-muted/20 p-3 lg:grid-cols-[1.4fr_1fr_1fr_100px_120px_40px]"
                    >
                      <div className="space-y-1.5">
                  ...
                  <div className="space-y-2 p-4">
                    {(project.services ?? []).map((service, index) => (
                      <div
                        ...
                        className="grid grid-cols-[1fr_100px_40px] gap-2"
                      >
                        <Input
                ...
                <div className="rounded-lg border border-border bg-background shadow-sm">
                  ...
                  <div className="space-y-2 p-4">
                    {(project.workflowStages ?? []).map((stage, index) => (
                      <div
                        key={stage.id ?? index}
                        className="grid gap-2 rounded-md border border-border/70 bg-muted/20 p-2 sm:grid-cols-[1fr_86px_86px_40px]"
                      >
                        <Input
                          value={stage.name}
              ...
              {step === 1 && (
                <div className="space-y-3">
                  ...
                  <p className="text-right text-sm text-muted-foreground">
                    Total sheets:{" "}
                    <span className="font-semibold text-foreground">{totalSheets}</span>
                  </p>
                </div>
              )}
